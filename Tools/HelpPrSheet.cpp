...
CHelpPrSheet::CHelpPrSheet(UINT nIDCaption, CWnd* pParentWnd, UINT iSelectPage,BOOL bStacked)
	:CPropertySheet(nIDCaption, pParentWnd, iSelectPage)
{
	m_bStacked = bStacked;
}

CHelpPrSheet::CHelpPrSheet(LPCTSTR pszCaption, CWnd* pParentWnd, UINT iSelectPage,BOOL bStacked)
...
int CHelpPrSheet::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
	// Set for Scrolling Tabs style
	EnableStackedTabs(m_bStacked);
