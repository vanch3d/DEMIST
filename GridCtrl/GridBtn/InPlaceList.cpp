...
// CBtnInPlaceList from http://www.codeguru.com/listview
//
...
// file.
//
// 6 Aug 1998 - Added CBtnComboEdit to subclass the edit control - code provided by
...
BOOL CBtnComboEdit::PreTranslateMessage(MSG* pMsg)
{
...
BEGIN_MESSAGE_MAP(CBtnComboEdit, CEdit)
	//{{AFX_MSG_MAP(CBtnComboEdit)
	ON_WM_KILLFOCUS()
	ON_WM_KEYDOWN()
	ON_WM_KEYUP()
	//}}AFX_MSG_MAP
...
/////////////////////////////////////////////////////////////////////////////
// CBtnComboEdit message handlers

void CBtnComboEdit::OnKillFocus(CWnd* pNewWnd)
{
	CEdit::OnKillFocus(pNewWnd);

    CBtnInPlaceList* pOwner = (CBtnInPlaceList*) GetOwner();  // This MUST be a CBtnInPlaceList
    if (pOwner)
        pOwner->EndEdit();
}

void CBtnComboEdit::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags)
{
...
void CBtnComboEdit::OnKeyUp(UINT nChar, UINT nRepCnt, UINT nFlags)
{
	if (nChar == VK_ESCAPE)
	{
        CWnd* pOwner = GetOwner();
...
CBtnInPlaceList::CBtnInPlaceList(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
...
CBtnInPlaceList::~CBtnInPlaceList()
{
}

void CBtnInPlaceList::EndEdit()
{
    CString str;
    GetWindowText(str);
...
void CBtnInPlaceList::PostNcDestroy()
{
...
BEGIN_MESSAGE_MAP(CBtnInPlaceList, CComboBox)
	//{{AFX_MSG_MAP(CBtnInPlaceList)
	ON_WM_KILLFOCUS()
	ON_WM_KEYDOWN()
	ON_WM_KEYUP()
...
/////////////////////////////////////////////////////////////////////////////
// CBtnInPlaceList message handlers

void CBtnInPlaceList::OnKillFocus(CWnd* pNewWnd)
{
...
void CBtnInPlaceList::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags)
{
	if ((nChar == VK_PRIOR || nChar == VK_NEXT ||
		 nChar == VK_DOWN  || nChar == VK_UP   ||
		 nChar == VK_RIGHT || nChar == VK_LEFT) &&
...
void CBtnInPlaceList::OnKeyUp(UINT nChar, UINT nRepCnt, UINT nFlags)
{
	if (nChar == VK_ESCAPE)
...
*****************************************************************************/
void CBtnInPlaceList::OnSelEndOK() 
{	
