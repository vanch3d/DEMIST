...
BEGIN_MESSAGE_MAP(C3DMeterCtrl, CStatic)
	...
	//}}AFX_MSG_MAP
	ON_MESSAGE(ANIM_DRAW_COMPONENT, OnDrawComponent)
END_MESSAGE_MAP()
...
LRESULT C3DMeterCtrl::OnDrawComponent (WPARAM wParam, LPARAM lParam)
{
	return 0;
}

void C3DMeterCtrl::Draw(CDC *pDC,CRect mrect)
{
	if (!pDC) return;
	...
	//CRect mrect2;
	//GetParent()->GetWindowRect(mrect2);
	...
	if ((m_dcBackground.GetSafeHdc() == NULL) || (m_bitmapBackground.m_hObject == NULL))
	{
		...
		m_bitmapBackground.CreateCompatibleBitmap(pDC, m_rectCtrl.Width(), 
					m_rectCtrl.Height()) ;
		...
		DrawMeterBackground(pDC, m_rectCtrl) ;
...
void C3DMeterCtrl::OnDrawItem(int nIDCtl, LPDRAWITEMSTRUCT lpDrawItemStruct) 
{
	// TODO: Add your message handler code here and/or call default
...
void C3DMeterCtrl::OnPaintClipboard(CWnd* pClipAppWnd, HGLOBAL hPaintStruct) 
{
	// TODO: Add your message handler code here and/or call default
	
	CStatic::OnPaintClipboard(pClipAppWnd, hPaintStruct);
}

BOOL C3DMeterCtrl::PreTranslateMessage(MSG* pMsg) 
{
	// TODO: Add your specialized code here and/or call the base class
	return CStatic::PreTranslateMessage(pMsg);
}

LRESULT C3DMeterCtrl::DefWindowProc(UINT message, WPARAM wParam, LPARAM lParam) 
{
	// TODO: Add your specialized code here and/or call the base class
...
void C3DMeterCtrl::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct)
{
}



void C3DMeterCtrl::PreSubclassWindow() 
{
	// TODO: Add your specialized code here and/or call the base class
